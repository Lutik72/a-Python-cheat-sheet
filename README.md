...
### Оператор and
При помощи оператора and объединяется два условия.

Это означает, блок кода выполняется только при выполнении **обоих условий одновременно!**
### Оператор or
Также применяется для объединения условий. 

Для выполнения блока кода достаточно выполнения хотя бы одного из условий. (Если есть хоть одна истинность - то выражение истинно)
